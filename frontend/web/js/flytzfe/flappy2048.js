...
game.div.style.height = '80%';
game.div.style.border = '1px solid red';
...
var flap = loadGameSound('http://pic.ibaotu.com/00/56/77/92g888piC9pj.mp3', 3);

var coin = loadGameSound('http://pic.ibaotu.com/00/56/77/92g888piC9pj.mp3', 1);

var punch = loadGameSound('http://pic.ibaotu.com/00/56/77/92g888piC9pj.mp3', 1);
...
wing.img = loadGameImage('images/flytzfe/wing.png'); // 150 x 131
...
wingfill.img = loadGameImage('images/flytzfe/wingfill.png'); // 150 x 131
...
logo.showing = true;
logo.hiding = false;
logo.img = loadGameImage('images/flytzfe/logo.png'); // 626 x 188
...
gameover.showing = false;
gameover.hiding = true;
gameover.img = loadGameImage('images/flytzfe/gameover.png'); // 626 x 144
...
fbshare.showing = false;
fbshare.hiding = true;
fbshare.img = loadGameImage('images/flytzfe/fbshare.png');
...
//   link: 'http://flappy2048.com/',
   name: 'Flappy 2048',
   picture: 'images/flytzfe/fbthumb.jpg',
   caption: '',
...
playagain.showing = false;
playagain.hiding = true;
playagain.img = loadGameImage('images/flytzfe/playagain.png');
...
c2s.showing = true;
c2s.hiding = false;
c2s.img = loadGameImage('images/flytzfe/clicktostart.png'); // 337 x 75
...
sndo.div.style.backgroundImage = 'url("images/flytzfe/soundoff.png")';
sndo.has_sound = true;
...
ground.bit = loadGameImage('images/flytzfe/ground.png');
