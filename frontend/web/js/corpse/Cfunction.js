var $User = function() {
	...
	ShadowPNG = "images/corpse/plantshadow" + ($User.Browser.IE6 ? (document.execCommand("BackgroundImageCache", false, true), "8.gif") : "32.png"),
	innerText = (function() {
	...
	oS = {
		...
		Init: function(e, g, b, d) {
			...
			$P = [];
			EDAll = $("dAll");
			console.log(EDAll.cloneNode(true));
			EDNewAll = EDAll.cloneNode();
			...
			!this.backgroundImage && (this.backgroundImage = "images/corpse/interface/background1.jpg");
			...
			function() {
				...
				!oS.InitLawnMower && (oS.InitLawnMower = function() {
					...
					while (--f) {
						h[f] = 1;
						NewImg("LawnMower" + f, "images/corpse/LawnMower.gif", "left:" + oS.LawnMowerX + "px;top:" + (GetY(f) - 60) + "px;z-index:" + (3 * f + 2), EDAll)
					}
				})
			})();
			g && oP.Init(g);
		...
		CheckImg: function(b, a) {
			...
			// console.log($('imgFlagHead').style.left);
			...
			if (c.AccessNum == c.PicNum) {
				...
				(c.LoadAccess ||
				function() {
					NewImg("imgGrowSoil", "images/corpse/interface/GrowSoil.png", "display:none;z-index:50", EDAll);
	...
	oGd = {
		...
		MB1: function(e, j, m, f) {
			var d = e.id,
				...
				l = e.ChangeC,
				b = oZ.getZ(q, g, a);
			n < 1 && f[g + "_" + c] && l != c && ((e.Kind = ++n) && (h = e.Attack = 40), e.ChangeC = c, k.src = "images/corpse/Plants/PB" + n + a + ".gif");
			b && b.Altitude == 1 ? (b.getHurt(-1, a, h, n, 0, 0, 0), m.splice(j, 1), (SetStyle(k, {
				left: e.pixelLeft + 28 + "px"
			})).src = "images/corpse/Plants/PeaBulletHit.gif", oSym.addTask(10, ClearChild, [k])) : (e.X += (p = !a ? 5 : -5)) < oS.W && e.X > 100 ? k.style.left = (e.pixelLeft += p) + "px" : (m.splice(j, 1), ClearChild(k))
		},
		MB2: function(d, g, h) {
			var c = d.id,
				j = d.X,
			...
			})).src = "images/corpse/Plants/ShroomBulletHit.gif", oSym.addTask(10, ClearChild, [e])) : (d.X += 5) < oS.W ? e.style.left = (d.pixelLeft += 5) + "px" : (h.splice(g, 1), ClearChild(e))
		},
		MB3: function(g, d, a) {
			var h = g.id,
				b = $(h),
	...
	ChoseShovel = function(a) {
		WhichMouseButton(a) < 2 && (SetNone($("imgShovel")), NewImg("tShovel", "images/corpse/interface/Shovel.png", "left:" + (a.clientX - 10) + "px;top:" + (a.clientY + document.body.scrollTop - 17) + "px;z-index:1", EDAll), oS.Chose = -1, StopBubble(a))
	},
	...
	AppearSun = function(h, f, e, a) {
		...
		NewImg(g, "images/corpse/Sun.gif", c, EDAll, {
			onclick: function() {
				ClickSun(this.id)
			}
		});
	...
	ShowLargeWave = function(a) {
		NewImg("LargeWave", "images/corpse/LargeWave.gif", "left:71px;top:249px;width:858px;height:102px;z-index:50", EDAll);
	...
	ShowFinalWave = function() {
		var a = function(b) {
				NewImg("FinalWave", "images/corpse/FinalWave.gif", "left:122px;top:194px;width:756px;height:213px;z-index:50", EDAll);
	...
	GameOver = function() {
		NewImg("iGameOver", "images/corpse/ZombiesWon.png", "width:900px;height:600px;z-index:255", EDAll, {
			onclick: function() {
				SelectModal(oS.Lvl)
			}
		})
	...
	PrepareGrowPlants = function(a) {
		NewImg("PrepareGrow", "images/corpse/PrepareGrowPlants.gif" + $Random + Math.random(), "z-index:50;left:" + (oS.W * 0.5 - 77) + "px;top:" + (oS.H * 0.5 - 54) + "px", EDAll);
...
CheckAutoSun = function(a) {
	...
	oSym.Init(function(d) {
		...
		c && ClearChild(c);
		NewEle("JSPVZ", "script", "", {
			src: "js/corpse/level/" + (oS.Lvl = d) + ".js",
	...
	var a = arguments.length;
	while (a--) {
		arguments[a-1].style.display = "block"
	}
}, SetNone = function() {
	var a = arguments.length;
	while (a--) {
