var CZombies = function(b, a) {
	...
	oZombie = InheritO(OrnNoneZombies, {
		...
		CName: "领带僵尸",
		PicArr: (function() {
			var a = "images/corpse/Zombies/Zombie/";
	...
	oFlagZombie = InheritO(oZombie, {
		...
		PicArr: {
			0: "images/corpse/Zombies/FlagZombie/FlagZombie.gif",
			1: "images/corpse/Zombies/FlagZombie/FlagZombieAttack.gif",
			2: "images/corpse/Zombies/FlagZombie/FlagZombieLostHead.gif",
			3: "images/corpse/Zombies/FlagZombie/FlagZombieLostHeadAttack.gif"
		}
	}),
	...
	oConeheadZombie = InheritO(OrnIZombies, {
		...
		Lvl: 2,
		PicArr: (function() {
			var b = "images/corpse/Zombies/ConeheadZombie/",
				a = "images/corpse/Zombies/Zombie/";
	...
	oBucketheadZombie = InheritO(oConeheadZombie, {
		...
		PicArr: {
			0: "images/corpse/Zombies/BucketheadZombie/BucketheadZombie.gif",
			1: "images/corpse/Zombies/BucketheadZombie/BucketheadZombieAttack.gif",
			7: "images/corpse/Zombies/Zombie/Zombie2.gif"
		}
	}),
	oFootballZombie = InheritO(oConeheadZombie, {
		...
		PicArr: {
			0: "images/corpse/Zombies/FootballZombie/FootballZombie.gif",
			1: "images/corpse/Zombies/FootballZombie/FootballZombieAttack.gif",
			7: "images/corpse/Zombies/FootballZombie/FootballZombieOrnLost.gif",
			8: "images/corpse/Zombies/FootballZombie/FootballZombieOrnLostAttack.gif"
		}
	}),
	oPoleVaultingZombie = InheritO(OrnNoneZombies, {
		...
		Lvl: 2,
		PicArr: (function() {
			var a = "images/corpse/Zombies/PoleVaultingZombie/";
		...
		NormalAttack: function(d, b) {
			var g = $Z[d],
				...
				c = a.firstChild,
				e = a.childNodes[1];
			e.src = "images/corpse/Zombies/PoleVaultingZombie/PoleVaultingZombieJump.gif" + $Random + Math.random();
			SetNone(c);
			g.isAttacking = 1;
			g.Altitude = 2;
			oSym.addTask(100, function(l, j, h, k, r) {
				...
				q && ((m = $P[j]) && m.Stature > 0 ? (q.AttackedRX = (q.X = (q.AttackedLX = q.ZX = n = m.AttackedRX) - q.beAttackedPointL) + q.beAttackedPointR, SetStyle(h, {
					left: q.X + "px"
				}), r.src = "images/corpse/Zombies/PoleVaultingZombie/PoleVaultingZombieWalk.gif", SetBlock(k), q.isAttacking = 0, q.Altitude = 1, q.OSpeed = q.Speed = 1.6, q.NormalGif = 7, q.LostHeadGif = 8, q.NormalAttack = CZombies.prototype.NormalAttack, q.getRaven = CZombies.prototype.getRaven) : (q.ZX = q.AttackedLX = (q.X = (q.AttackedRX = f) - q.beAttackedPointR) + q.beAttackedPointL, SetStyle(h, {
					left: q.X + "px"
				}), r.src = "images/corpse/Zombies/PoleVaultingZombie/PoleVaultingZombieJump2.gif" + $Random + Math.random(), SetBlock(k), oSym.addTask(80, function(s, u) {
					var t = $Z[s];
					t && (u.src = "images/corpse/Zombies/PoleVaultingZombie/PoleVaultingZombieWalk.gif", t.isAttacking = 0, t.Altitude = 1, t.OSpeed = t.Speed = 1.6, t.NormalGif = 7, t.LostHeadGif = 8, t.NormalAttack = CZombies.prototype.NormalAttack, t.getRaven = CZombies.prototype.getRaven)
				}, [l, r])))
			}, [d, b, a, c, e])
		}
	}),
	...
	oNewspaperZombie = InheritO(OrnIIZombies, {
		...
		LostPaperSpeed: 4.8,
		PicArr: (function() {
			var a = "images/corpse/Zombies/NewspaperZombie/";
