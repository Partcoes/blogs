var CPlants = NewO({
	...
	oStarfruit = InheritO(CPlants, {
		...
		beAttackedPointR: 57,
		SunNum: 125,
		PicArr: ["images/corpes/Card/Plants/Starfruit.png", "images/corpes/Card/Plants/StarfruitG.png", "images/corpes/Plants/Starfruit/Starfruit.gif", "images/corpes/Plants/Starfruit/Star.gif"],
		Tooltip: "向五个方向发射小杨桃",
		...
		PrivateBirth: function(d) {
			...
			d.BulletEle = NewImg(0, "images/corpes/Plants/Starfruit/Star.gif", "left:" + b + "px;top:" + a + "px;z-index:" + (d.zIndex + 2))
		},
		PrivateDie: function(a) {
			a.BulletEle = null
		},
	...
	oPeashooter = InheritO(CPlants, {
		...
		SunNum: 100,
		BKind: 0,
		PicArr: ["images/corpes/Card/Plants/Peashooter.png", "images/corpes/Card/Plants/PeashooterG.png", "images/corpes/Plants/Peashooter/Peashooter.gif", "images/corpes/Plants/PB00.gif", "images/corpes/Plants/PeaBulletHit.gif"],
		Tooltip: "向敌人射出豌豆",
	...
	oSnowPea = InheritO(oPeashooter, {
		...
		SunNum: 175,
		BKind: -1,
		PicArr: ["images/corpes/Card/Plants/SnowPea.png", "images/corpes/Card/Plants/SnowPeaG.png", "images/corpes/Plants/SnowPea/SnowPea.gif", "images/corpes/Plants/PB-10.gif", "images/corpes/Plants/PeaBulletHit.gif"],
	...
	oRepeater = InheritO(oPeashooter, {
		...
		beAttackedPointR: 53,
		SunNum: 200,
		PicArr: ["images/corpes/Card/Plants/Repeater.png", "images/corpes/Card/Plants/RepeaterG.png", "images/corpes/Plants/Repeater/Repeater.gif", "images/corpes/Plants/PB00.gif", "images/corpes/Plants/PeaBulletHit.gif"],
		Tooltip: "一次发射两颗豌豆",
	...
	oThreepeater = InheritO(oPeashooter, {
		...
		beAttackedPointR: 53,
		SunNum: 325,
		PicArr: ["images/corpes/Card/Plants/Threepeater.png", "images/corpes/Card/Plants/ThreepeaterG.png", "images/corpes/Plants/Threepeater/Threepeater.gif", "images/corpes/Plants/PB00.gif", "images/corpes/Plants/PeaBulletHit.gif"],
		Tooltip: "一次射出三行的豌豆",
		...
		PrivateBirth: function(f) {
			...
			for (b in c) {
				...
				f.BulletEle.push(NewImg(0, "images/corpes/Plants/PB00.gif", "left:" + d + "px;top:" + (GetY(b) - 50) + "px;display:none;z-index:" + (3 * b + 2)))
			}
		},
		PrivateDie: function(a) {
	...
	oGatlingPea = InheritO(oPeashooter, {
		...
		SunNum: 250,
		coolTime: 50000,
		PicArr: ["images/corpes/Card/Plants/GatlingPea.png", "images/corpes/Card/Plants/GatlingPeaG.png", "images/corpes/Plants/GatlingPea/GatlingPea.gif", "images/corpes/Plants/PB00.gif", "images/corpes/Plants/PeaBulletHit.gif"],
	...
	oSplitPea = InheritO(oPeashooter, {
		...
		beAttackedPointR: 72,
		SunNum: 125,
		PicArr: ["images/corpes/Card/Plants/SplitPea.png", "images/corpes/Card/Plants/SplitPeaG.png", "images/corpes/Plants/SplitPea/SplitPea.gif", "images/corpes/Plants/PB00.gif", "images/corpes/Plants/PB01.gif", "images/corpes/Plants/PeaBulletHit.gif"],
		Tooltip: "前后双向发射豌豆",
	...
	oSunFlower = InheritO(CPlants, {
		...
		beAttackedPointR: 53,
		SunNum: 50,
		PicArr: ["images/corpes/Card/Plants/SunFlower.png", "images/corpes/Card/Plants/SunFlowerG.png", "images/corpes/Plants/SunFlower/SunFlower.gif"],
		Tooltip: "提供你额外的阳光",
	...
	oTwinSunflower = InheritO(oSunFlower, {
		...
		SunNum: 150,
		coolTime: 50000,
		PicArr: ["images/corpes/Card/Plants/TwinSunflower.png", "images/corpes/Card/Plants/TwinSunflowerG.png", "images/corpes/Plants/TwinSunflower/TwinSunflower.gif"],
	...
	oPumpkinHead = InheritO(CPlants, {
		...
		coolTime: 30000,
		zIndex: 1,
		PicArr: ["images/corpes/Card/Plants/PumpkinHead.png", "images/corpes/Card/Plants/PumpkinHeadG.png", "images/corpes/Plants/PumpkinHead/PumpkinHead.gif", "images/corpes/Plants/PumpkinHead/PumpkinHead1.gif", "images/corpes/Plants/PumpkinHead/PumpkinHead2.gif", "images/corpes/Plants/PumpkinHead/pumpkin_damage1.gif", "images/corpes/Plants/PumpkinHead/pumpkin_damage2.gif", "images/corpes/Plants/PumpkinHead/Pumpkin_back.gif"],
		Tooltip: "能保护种在里面的植物",
		...
		getHurt: function(e, c, b) {
			...
			case (d.HP -= b) < 1:
				...
				break;
			case d.HP < 1334:
				d.HurtStatus < 2 && (d.HurtStatus = 2, a.childNodes[1].src = "images/corpes/corpse/Plants/PumpkinHead/pumpkin_damage2.gif");
				break;
			case d.HP < 2667:
				d.HurtStatus < 1 && (d.HurtStatus = 1, a.childNodes[1].src = "images/corpes/corpse/Plants/PumpkinHead/pumpkin_damage1.gif", $(f + "_2").src = "images/corpes/corpse/Plants/PumpkinHead/Pumpkin_back.gif")
			}
		},
		InitTrigger: function() {},
		BirthStyle: function(c, d, b, a) {
			b.childNodes[1].src = "images/corpes/corpse/Plants/PumpkinHead/PumpkinHead1.gif";
			EditEle(b, {
				id: d
			}, a, EDAll);
			NewImg(d + "_2", "images/corpes/Plants/PumpkinHead/PumpkinHead2.gif", "left:" + c.pixelLeft + "px;top:" + c.pixelTop + "px;z-index:" + (c.zIndex - 2), EDAll)
		},
		PrivateDie: function(a) {
			ClearChild($(a.id + "_2"))
		}
	...
	oFlowerPot = InheritO(CPlants, {
		...
		beAttackedPointR: 52,
		SunNum: 25,
		PicArr: ["images/corpes/Card/Plants/FlowerPot.png", "images/corpes/Card/Plants/FlowerPotG.png", "images/corpes/Plants/FlowerPot/FlowerPot.gif"],
		PKind: 0,
		Stature: -1,
		GetDY: function(b, c, a) {
			return 6
	...
	oLilyPad = InheritO(oFlowerPot, {
		...
		height: 58,
		beAttackedPointR: 59,
		PicArr: ["images/corpes/Card/Plants/LilyPad.png", "images/corpes/Card/Plants/LilyPadG.png", "images/corpes/Plants/LilyPad/LilyPad.gif"],
		CanGrow: function(c, b, d) {
			var a = b + "_" + d;
	...
	oPotatoMine = InheritO(CPlants, {
		...
		PicArr: ["images/corpes/Card/Plants/PotatoMine.png", "images/corpes/Card/Plants/PotatoMineG.png", "images/corpes/Plants/PotatoMine/PotatoMine.gif", "images/corpes/Plants/PotatoMine/PotatoMineNotReady.gif", "images/corpes/Plants/PotatoMine/PotatoMine_mashed.gif", "images/corpes/Plants/PotatoMine/ExplosionSpudow.gif"],
		...
		canTrigger: 0,
		BirthStyle: function(c, d, b, a) {
			b.childNodes[1].src = "images/corpes/corpse/Plants/PotatoMine/PotatoMineNotReady.gif";
			EditEle(b, {
				id: d
			}, a, EDAll)
		},
		PrivateBirth: function(a) {
			oSym.addTask(1500, function(c) {
				var b = $P[c];
				b && ($(c).childNodes[1].src = "images/corpes/Plants/PotatoMine/PotatoMine.gif", b.Status = 1, b.canTrigger = 1, b.getHurt = function(g, e, d) {
					var f = this;
		...
		NormalAttack: function(k, j, f) {
			...
			EditEle(d.childNodes[1], {
				src: "images/corpes/Plants/PotatoMine/PotatoMine_mashed.gif"
			}, {
				width: "132px",
				height: "93px",
				left: "-40px",
			...
			NewImg(0, "images/corpes/Plants/PotatoMine/ExplosionSpudow.gif", "left:-90px;top:-40px", d);
	...
	oTorchwood = InheritO(CPlants, {
		...
		beAttackedPointR: 53,
		SunNum: 175,
		PicArr: ["images/corpes/Card/Plants/Torchwood.png", "images/corpes/Card/Plants/TorchwoodG.png", "images/corpes/Plants/Torchwood/Torchwood.gif", "images/corpes/Plants/PB00.gif", "images/corpes/Plants/PB01.gif", "images/corpes/Plants/PB10.gif", "images/corpes/Plants/PB11.gif", "images/corpes/Plants/Torchwood/SputteringFire.gif"],
	...
	oWallNut = InheritO(CPlants, {
		...
		HP: 4000,
		coolTime: 30000,
		PicArr: ["images/corpes/Card/Plants/WallNut.png", "images/corpes/Card/Plants/WallNutG.png", "images/corpes/Plants/WallNut/WallNut.gif", "images/corpes/Plants/WallNut/Wallnut_cracked1.gif", "images/corpes/Plants/WallNut/Wallnut_cracked2.gif"],
		...
		getHurt: function(e, b, a) {
			var c = this,
				d = $(c.id).childNodes[1];
			!(b % 3) ? (c.HP -= a) < 1 ? c.Die() : c.HP < 1334 ? c.HurtStatus < 2 && (c.HurtStatus = 2, d.src = "images/corpes/Plants/WallNut/Wallnut_cracked2.gif") : c.HP < 2667 && c.HurtStatus < 1 && (c.HurtStatus = 1, d.src = "images/corpes/Plants/WallNut/Wallnut_cracked1.gif") : c.Die(1)
		}
	}),
	oTallNut = InheritO(oWallNut, {
		...
		SunNum: 125,
		HP: 8000,
		PicArr: ["images/corpes/Card/Plants/TallNut.png", "images/corpes/Card/Plants/TallNutG.png", "images/corpes/Plants/TallNut/TallNut.gif", "images/corpes/Plants/TallNut/TallnutCracked1.gif", "images/corpes/Plants/TallNut/TallnutCracked2.gif"],
		Tooltip: "不会被跳过的坚实壁垒",
		...
		getHurt: function(e, b, a) {
			var c = this,
				d = $(c.id).childNodes[1];
			!(b % 3) ? (c.HP -= a) < 1 ? c.Die() : c.HP < 2667 ? c.HurtStatus < 2 && (c.HurtStatus = 2, d.src = "images/corpes/Plants/TallNut/TallnutCracked2.gif") : c.HP < 5333 && c.HurtStatus < 1 && (c.HurtStatus = 1, d.src = "images/corpes/Plants/TallNut/TallnutCracked1.gif") : c.Die(1)
		}
	}),
	oCherryBomb = InheritO(CPlants, {
		...
		SunNum: 150,
		coolTime: 50000,
		PicArr: ["images/corpes/Card/Plants/CherryBomb.png", "images/corpes/Card/Plants/CherryBombG.png", "images/corpes/Plants/CherryBomb/CherryBomb.gif", "images/corpes/Plants/CherryBomb/Boom.gif"],
			...
			oSym.addTask(63, function(b) {
				...
				if (c) {
					...
					EditEle(f.childNodes[1], {
						src: "images/corpes/Plants/CherryBomb/Boom.gif"
					}, {
						width: "213px",
						height: "160px",
						left: "-50px",
	...
	oJalapeno = InheritO(oCherryBomb, {
		...
		height: 89,
		beAttackedPointR: 48,
		PicArr: ["images/corpes/Card/Plants/Jalapeno.png", "images/corpes/Card/Plants/JalapenoG.png", "images/corpes/Plants/Jalapeno/Jalapeno.gif", "images/corpes/Plants/Jalapeno/JalapenoAttack.gif"],
		Tooltip: "消灭整行的敌人",
			...
			oSym.addTask(72, function(g) {
				...
				if (f) {
					...
					EditEle(b.childNodes[1], {
						src: "images/corpes/Plants/Jalapeno/JalapenoAttack.gif"
					}, {
	...
	oSpikeweed = InheritO(CPlants, {
		...
		Stature: -1,
		canEat: 0,
		PicArr: ["images/corpes/Card/Plants/Spikeweed.png", "images/corpes/Card/Plants/SpikeweedG.png", "images/corpes/Plants/Spikeweed/Spikeweed.gif"],
		Attack: 20,
		ArZ: {},
	...
	oSpikerock = InheritO(oSpikeweed, {
		...
		SunNum: 125,
		coolTime: 50000,
		PicArr: ["images/corpes/Card/Plants/Spikerock.png", "images/corpes/Card/Plants/SpikerockG.png", "images/corpes/Plants/Spikerock/Spikerock.gif"],
		Attack: 40,
	...
	oGarlic = InheritO(CPlants, {
		...
		SunNum: 50,
		HP: 400,
		PicArr: ["images/corpes/Card/Plants/Garlic.png", "images/corpes/Card/Plants/GarlicG.png", "images/corpes/Plants/Garlic/Garlic.gif", "images/corpes/Plants/Garlic/Garlic_body2.gif", "images/corpes/Plants/Garlic/Garlic_body3.gif"],
		Tooltip: "将僵尸赶到其它的横行",
		...
		getHurt: function(e, b, a) {
			var c = this,
				d = $(c.id).childNodes[1];
			!(b % 3) ? (c.HP -= 20) < 1 ? c.Die() : (c.ChangeR(c, e), c.HP < 134 ? c.HurtStatus < 2 && (c.HurtStatus = 2, d.src = "images/corpes/Plants/Garlic/Garlic_body3.gif") : c.HP < 267 && c.HurtStatus < 1 && (c.HurtStatus = 1, d.src = "images/corpes/Plants/Garlic/Garlic_body2.gif")) : c.Die(1)
		},
	...
	oSquash = InheritO(CPlants, {
		...
		SunNum: 50,
		coolTime: 30000,
		PicArr: ["images/corpes/Card/Plants/Squash.png", "images/corpes/Card/Plants/SquashG.png", "images/corpes/Plants/Squash/Squash.gif", "images/corpes/Plants/Squash/SquashAttack.gif"],
		Tooltip: "压扁接近的僵尸",
		...
		NormalAttack: function(d) {
			...
			a.childNodes[1].src = "images/corpes/Plants/Squash/SquashAttack.gif";
			SetStyle(a, {
				left: b + "px"
			});
			c.Die(1);
	...
	oChomper = InheritO(CPlants, {
		...
		beAttackedPointR: 70,
		SunNum: 150,
		PicArr: ["images/corpes/Card/Plants/Chomper.png", "images/corpes/Card/Plants/ChomperG.png", "images/corpes/Plants/Chomper/Chomper.gif", "images/corpes/Plants/Chomper/ChomperAttack.gif", "images/corpes/Plants/Chomper/ChomperDigest.gif"],
		...
		NormalAttack: function(a, b) {
			$(a).childNodes[1].src = "images/corpes/Plants/Chomper/ChomperAttack.gif" + $Random + Math.random();
			oSym.addTask(70, function(c, d) {
				...
				$P[c] && ((e = $Z[d]) && e.beAttacked ? oSym.addTask(18, function(f) {
					...
					g && ($(f).childNodes[1].src = e.getRaven(f) ? (oSym.addTask(4200, function(h) {
						var i = $P[h];
						i && (i.canTrigger = 1, $(h).childNodes[1].src = "images/corpes/Plants/Chomper/Chomper.gif")
					}, [f]), "images/corpes/Plants/Chomper/ChomperDigest.gif") : (g.canTrigger = 1, "images/corpes/Plants/Chomper/Chomper.gif"))
				}, [c]) : oSym.addTask(18, function(f) {
					var g = $P[f];
					g && (g.canTrigger = 1, $(f).childNodes[1].src = "images/corpes/Plants/Chomper/Chomper.gif")
				}, [c]))
			}, [a, b])
		}
	}),
	oFumeShroom = InheritO(CPlants, {
		...
		SunNum: 75,
		SleepGif: 3,
		PicArr: ["images/corpes/Card/Plants/FumeShroom.png", "images/corpes/Card/Plants/FumeShroomG.png", "images/corpes/Plants/FumeShroom/FumeShroom.gif", "images/corpes/Plants/FumeShroom/FumeShroomSleep.gif", "images/corpes/Plants/FumeShroom/FumeShroomAttack.gif", "images/corpes/Plants/FumeShroom/FumeShroomBullet.gif"],
		Tooltip: "喷射可以穿过门板的气液",
		...
		PrivateBirth: function(b) {
			var a = b.id;
			NewEle(a + "_Bullet", "div", "position:absolute;display:none;width:343px;height:62px;left:" + b.AttackedRX + "px;top:" + (b.pixelTop + 5) + "px;background:url(images/corpes/Plants/FumeShroom/FumeShroomBullet.gif);z-index:" + (b.zIndex + 1), 0, EDAll)
		},
		PrivateDie: function(a) {
		...
		NormalAttack: function() {
			...
			b.childNodes[1].src = "images/corpes/Plants/FumeShroom/FumeShroomAttack.gif";
			SetBlock($(a));
			ImgSpriter(a, c, [
				["0 0", 90, 1],
				["0 -62px", 90, 2],
				...
				var h = $(j);
				$P[j] && (h.childNodes[1].src = "images/corpes/Plants/FumeShroom/FumeShroom.gif");
				SetNone($(i))
			})
		}
	}),
	oCoffeeBean = InheritO(CPlants, {
		...
		PKind: 3,
		canEat: 0,
		PicArr: ["images/corpes/Card/Plants/CoffeeBean.png", "images/corpes/Card/Plants/CoffeeBeanG.png", "images/corpes/Plants/CoffeeBean/CoffeeBean.gif", "images/corpes/Plants/CoffeeBean/CoffeeBeanEat.gif"],
		...
		BirthStyle: function(c, d, b, a) {
			b.childNodes[1].src = "images/corpes/Plants/CoffeeBean/CoffeeBeanEat.gif" + $Random + Math.random();
			EditEle(b, {
				id: d
			}, a, EDAll)
		},
	...
	oGloomShroom = InheritO(oFumeShroom, {
		...
		SunNum: 150,
		coolTime: 50000,
		PicArr: ["images/corpes/Card/Plants/GloomShroom.png", "images/corpes/Card/Plants/GloomShroomG.png", "images/corpes/Plants/GloomShroom/GloomShroom.gif", "images/corpes/Plants/GloomShroom/GloomShroomSleep.gif", "images/corpes/Plants/GloomShroom/GloomShroomAttack.gif", "images/corpes/Plants/GloomShroom/GloomShroomBullet.gif"],
		...
		PrivateBirth: function(b) {
			var a = b.id;
			NewEle(a + "_Bullet", "div", "position:absolute;display:none;width:210px;height:200px;left:" + (b.pixelLeft - 60) + "px;top:" + (b.pixelTop - 65) + "px;background:url(images/corpes/Plants/GloomShroom/GloomShroomBullet.gif);z-index:" + (b.zIndex + 1), 0, EDAll)
		},
		PrivateDie: function(a) {
			ClearChild($(a.id + "_Bullet"))
		},
		...
		NormalAttack: function() {
			...
			d.childNodes[1].src = "images/corpes/Plants/GloomShroom/GloomShroomAttack.gif";
			SetBlock($(l));
			ImgSpriter(l, j, [
				["0 0", 90, 1],
				["0 -200px", 90, 2],
				...
				var i = $(n);
				$P[n] && (i.childNodes[1].src = "images/corpes/Plants/GloomShroom/GloomShroom.gif");
				SetNone($(m))
			})
		}
	}),
	oPuffShroom = InheritO(oFumeShroom, {
		...
		SunNum: 0,
		Stature: -1,
		PicArr: ["images/corpes/Card/Plants/PuffShroom.png", "images/corpes/Card/Plants/PuffShroomG.png", "images/corpes/Plants/PuffShroom/PuffShroom.gif", "images/corpes/Plants/PuffShroom/PuffShroomSleep.gif", "images/corpes/Plants/ShroomBullet.gif", "images/corpes/Plants/ShroomBulletHit.gif"],
		Tooltip: "向敌人发射短程孢子",
		...
		PrivateBirth: function(c) {
			...
			c.BulletEle = NewImg(0, "images/corpes/Plants/ShroomBullet.gif", "left:" + a + "px;top:" + (c.pixelTop + 40) + "px;display:none;z-index:" + (c.zIndex + 2))
		},
		PrivateDie: function(a) {
			a.BulletEle = null
		},
	...
	oScaredyShroom = InheritO(oFumeShroom, {
		...
		ArZ: [],
		Attacking: 0,
		PicArr: ["images/corpes/Card/Plants/ScaredyShroom.png", "images/corpes/Card/Plants/ScaredyShroomG.png", "images/corpes/Plants/ScaredyShroom/ScaredyShroom.gif", "images/corpes/Plants/ScaredyShroom/ScaredyShroomSleep.gif", "images/corpes/Plants/ScaredyShroom/ScaredyShroomCry.gif", "images/corpes/Plants/ShroomBullet.gif", "images/corpes/Plants/ShroomBulletHit.gif"],
		...
		TriggerCheck: function(e, c) {
			var b = this,
				a = b.id;
			Math.abs(e.ZX - b.MX) < 121 && e.beAttacked ? (b.ArZ.push(e.id), !b.Cry && (b.Cry = 1, $(a).childNodes[1].src = "images/corpes/Plants/ScaredyShroom/ScaredyShroomCry.gif", b.CryCheck(a))) : (!b.Cry && !b.Attacking && e.Altitude > 0 && e.Altitude < 3 && b.NormalAttack())
		},
		PrivateBirth: function(c) {
			var b = c.AttackedLX,
				a = b - 46;
			...
			c.BulletEle = NewImg(0, "images/corpes/Plants/ShroomBullet.gif", "left:" + a + "px;top:" + (c.pixelTop + 35) + "px;display:none;z-index:" + (c.zIndex + 2));
			c.MX = b + 9
		},
		PrivateDie: function(a) {
			a.BulletEle = null
		...
		CryCheck: function(a) {
			oSym.addTask(140, function(b) {
				...
				if (d) {
					...
					f.length ? d.CryCheck(b) : (d.Cry = 0, $(b).childNodes[1].src = "images/corpes/Plants/ScaredyShroom/ScaredyShroom.gif")
				}
			}, [a])
		}
	}),
	oSunShroom = InheritO(oFumeShroom, {
		...
		Stature: -1,
		Status: 0,
		PicArr: ["images/corpes/Card/Plants/SunShroom.png", "images/corpes/Card/Plants/SunShroomG.png", "images/corpes/Plants/SunShroom/SunShroom2.gif", "images/corpes/Plants/SunShroom/SunShroomSleep.gif", "images/corpes/Plants/SunShroom/SunShroom.gif"],
		...
		BirthStyle: function(c, d, b, a) {
			oS.DKind ? (c.canTrigger = 0, c.Sleep = 1, b.childNodes[1].src = "images/corpes/Plants/SunShroom/SunShroomSleep.gif") : (oSym.addTask(600, function(h, g, f) {
				var e = $P[h];
				e && e.ProduceSun(e, g, f)
			}, [d, GetX(c.C) - 40, GetY(c.R)]), oSym.addTask(12000, function(f) {
				var e = $P[f];
				e && (e.Sleep = 0, $(f).childNodes[1].src = "images/corpes/Plants/SunShroom/SunShroom.gif", e.Status = 1)
			}, [d]));
			EditEle(b, {
				id: d
			}, a, EDAll)
		...
		WakeUP: function(a) {
			...
			$(b).childNodes[1].src = "images/corpes/Plants/SunShroom/SunShroom2.gif";
			a.Sleep = 0;
			oSym.addTask(12000, function(d) {
				var c = $P[d];
				c && ($(d).childNodes[1].src = "images/corpes/Plants/SunShroom/SunShroom.gif", c.Status = 1)
			}, [b])
		}
	});