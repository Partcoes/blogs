...
?>
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <?= $form->field($model, 'username')->textInput(['class'=>'username','placeholder'=>'please enter your username']) -> label("") ?>

            <?= $form->field($model, 'password')->passwordInput(['class'=>'password','placeholder'=>'please enter your password']) -> label("") ?>


            <div class="form-group">
                <?= Html::submitButton('登录', ['class' => 'button-login', 'name' => 'login-button']) ?>
            </div>
